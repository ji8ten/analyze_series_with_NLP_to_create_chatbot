...
from character_network._init_ import NamedEntityRecognizer, CharacterNetworkGenerator
from character_chatbot._init_ import CharacterChatBot
#import os
...
def get_themes(theme_list_str, subtitles_path, save_path):
    ...
    theme_list = [theme for theme in theme_list if theme != 'dialouge']
...
def chat_with_character_chatbot(message, history):
    character_chatbot = CharacterChatBot("ji8ten/Naruto_Llama-3.1-8B",
                                         #huggingface_token = os.getenv('huggingface_token')
                                         )
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        subtitles_path_ner = gr.Textbox(label="Subtitles or Script Path")
